...
#         identity_id = train_image.split("/")[-2]
#         race_sex_idt = f"{race_sex}_{identity_id}"
#         train_x.append(train_image)
#         train_y.append(race_sex_idt)
#
#     for test_image in selected_images:
#         race_sex = test_image.split("/")[-3]
#         identity_id = test_image.split("/")[-2]
#         race_sex_idt = f"{race_sex}_{identity_id}"
#         test_x.append(test_image)
#         test_y.append(race_sex_idt)
#
#
# for idx in range(10):
#     train_x = []
...
#     test_x = []
#     test_y = []
#     parent_path = '/Users/h0z058l/Downloads/FER/dataset/BFW/bfw-cropped-aligned'
...
#         race_sex_path = os.path.join(parent_path, race_sex)
#         create_image_to_label_map(race_sex_path)
#
#     json_dict = {
#         "train_path": train_x, "train_label": train_y, "test_path": test_x, "test_label": test_y
#     }
#     with open(f"/Users/h0z058l/Downloads/FER/codes/bfw/10-folder-selection/select_{idx}.json", 'w') as f:
...
for select_idx in range(10):
    ...
    with open(f"/Users/h0z058l/Downloads/FER/codes/bfw/10-folder-selection/select_{select_idx}.json") as f:
    ...
    with open(f"/Users/h0z058l/Downloads/FER/codes/bfw/10-folder-selection/select_{select_idx}.json", 'w') as f:
    ...
    datafile = h5py.File(f'/Users/h0z058l/Downloads/FER/codes/bfw/data_{select_idx}.h5', 'w')
