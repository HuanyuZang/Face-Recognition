...
#     }
#     with open(f"/Users/h0z058l/Downloads/FER/codes/Face-Recognition/10-folder-selection/select_{idx}.json", 'w') as f:
...
for select_idx in range(10):
    ...
    with open(f"/BFW/10-folder-selection/select_{select_idx}.json") as f:
    ...
    with open(f"/BFW/10-folder-selection/select_{select_idx}.json", 'w') as f:
    ...
    datafile = h5py.File(f'/Users/h0z058l/Downloads/FER/codes/Face-Recognition/data_{select_idx}.h5', 'w')
